...
#SBATCH --output=output/cl_train_ViT_medium3D_triple_CL_new_CLIP_GRID_SEARCH.out
...
ECG_TRAIN_DIR='/projects/prjs1252/CL_data/CL_ECG_leads_diastole_train.pt'
ECG_VAL_DIR='/projects/prjs1252/CL_data/CL_ECG_leads_diastole_val.pt'
CMR_TRAIN_DIR='/projects/prjs1252/CL_data/CL_cmr_tensor_diastole_train.pt'
CMR_VAL_DIR='/projects/prjs1252/CL_data/CL_cmr_tensor_diastole_val.pt'
...
# CONFIGURATION TRIPLE CL
checkpoint_path_cmr_systole='/home/abujalancegome/deep_risk/ECG-CMR-CL/cmr_pretrain/CMR_pretrain/3D_systole/ResNet503D_MLP_checkpoint-173-loss-93.42766754715531-lr-0.0001-wd-1e-5-ai-1.pth'
...
ECG_TRAIN_DIR='/projects/prjs1252/CL_data/ECG_data/CL_ECG_leads_diastole_train_3d.pt'
ECG_VAL_DIR='/projects/prjs1252/CL_data/ECG_data/CL_ECG_leads_diastole_val_3d.pt'

CMR_TRAIN_DIR='/projects/prjs1252/CL_data/ECG_data/CL_cmr_tensor_diastole_train_3d.pt'
CMR_VAL_DIR='/projects/prjs1252/CL_data/ECG_data/CL_cmr_tensor_diastole_val_3d.pt'

CMR_SYS_TRAIN_DIR='/projects/prjs1252/CL_data/ECG_data/CL_cmr_tensor_systole_train_3d.pt'
CMR_SYS_VAL_DIR='/projects/prjs1252/CL_data/ECG_data/CL_cmr_tensor_systole_val_3d.pt'
    ...
    do
        ...
        do
            ...
            python train_cl.py --model_name ResNet50-3D-MLP \
                ...
                --cmr_systole_train_path ${CMR_SYS_TRAIN_DIR} \
                --cmr_val_path ${CMR_VAL_DIR} \
                --ecg_val_path ${ECG_VAL_DIR} \
                --cmr_systole_val_path ${CMR_SYS_VAL_DIR} \
                --checkpoint_path_cmr ${checkpoint_path_cmr} \
                --checkpoint_path_ecg ${checkpoint_path_ecg} \
                --checkpoint_path_cmr_systole ${checkpoint_path_cmr_systole} \
                --num_outputs 3 \
                --temporal_dim 6 \
                --output_dir CL_results/medium3D_triple_CL_2 \
                --epochs 200 \
                --latent_dim 768 \
                --projection_dim 128 \
                --accum_iter ${ai} \
