...
#SBATCH --time=2:00:00
#SBATCH --output=output/fine_tune_ecg/medium3D_vol/CL_with_features_testing.out
...
TRAIN_DIR="/projects/prjs1252/CL_data/ECG_data/ECG_balanced_atrial_fibrilation_train_leads.pt"
VAL_DIR="/projects/prjs1252/CL_data/ECG_data/ECG_balanced_atrial_fibrilation_val_leads.pt"
TEST_DIR="/projects/prjs1252/CL_data/ECG_data/ECG_balanced_atrial_fibrilation_test_leads.pt"

TRAIN_LABELS_PTH="/projects/prjs1252/CL_data/ECG_data/ECG_balanced_atrial_fibrilation_train_labels.csv"
VAL_LABELS_PTH="/projects/prjs1252/CL_data/ECG_data/ECG_balanced_atrial_fibrilation_val_labels.csv"
TEST_LABELS_PTH="/projects/prjs1252/CL_data/ECG_data/ECG_balanced_atrial_fibrilation_test_labels.csv"
...
checkpoint="/home/abujalancegome/deep_risk/ECG-CMR-CL/CL_results/medium3D_diastole_w_labels_atrial/ECGEncoder_checkpoint-16-loss-4.650245666503906.pth"
